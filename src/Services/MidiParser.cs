...
{
    /// <summary>
    /// Handles MIDI file parsing and exposes note events for tab mapping.
    /// </summary>
    public class MidiParser
    {
        public List<MidiNote> Notes { get; private set; } = new List<MidiNote>();
        public int TicksPerQuarterNote { get; private set; } = 480; // Default, will be set by MIDI file
        ...
        public void LoadMidiFile(string filePath)
        {
            ...
            // Dictionary to keep track of note on events (key: note number, value: start time)
